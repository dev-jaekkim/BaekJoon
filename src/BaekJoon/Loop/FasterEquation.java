 ...
 */
public class FasterEquation {

    public void howFastCanYouGo() throws Exception{
        BufferedReader bf = new BufferedReader(new InputStreamReader(System.in));
        String firstLineCountString = bf.readLine();
        int testCaseCount = Integer.parseInt(firstLineCountString);
