 ...
 */
public class BeforeChristAfterChrist {

    public void calculateAfterChristYear() throws IOException {

        BufferedReader bf = new BufferedReader(new InputStreamReader(System.in));
        String st = bf.readLine();

        int yearNow = Integer.parseInt(st);
        System.out.println(yearNow - 544);
